...
public class ScrollUtil {
    ...
    public static boolean isScrollToBottom(RecyclerView recyclerView) {
        ...
        // 当前屏幕最后一个可见的item位置
        int lastVisibleItemPosition = RecyclerViewPositionHelper.createHelper(recyclerView).findLastVisibleItemPosition();
...
//        return visibleItemCount + firstVisibleItemPosition >= totalItemCount;
    ...
    public static boolean isScrollToBottom4(RecyclerView recyclerView) {
        ...
        // 根据item高度判断
        int itemCount = layoutManager.getItemCount();
        int lastPosition = RecyclerViewPositionHelper.createHelper(recyclerView).findLastCompletelyVisibleItemPosition();
