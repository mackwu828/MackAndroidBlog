 ...
 * ===================================================
 */
public class TryCatchAllMethodVisitor extends AdviceAdapter {
    ...
    protected TryCatchAllMethodVisitor(MethodVisitor methodVisitor, int access, String name, String descriptor) {
