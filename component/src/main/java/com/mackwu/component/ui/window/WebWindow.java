...
public class WebWindow {
    ...
    private WebWindow() {
        ...
        LogUtil.d("WebWindow init...  " + ProcessUtil.getProcessInfo(context));
        initWindow(context);
        initView();
    }
    ...
    public void show() {
        LogUtil.d("show...  " + ProcessUtil.getProcessInfo(context) + ", webView=" + webView);
        if (webView != null) webView.post(() -> Objects.requireNonNull(FloatWindow.get(TAG)).show());
    }

    public void hide() {
        LogUtil.d("hide...  " + ProcessUtil.getProcessInfo(context));
        if (webView != null) webView.post(() -> Objects.requireNonNull(FloatWindow.get(TAG)).hide());
    }

    public void loadUrl() {
        LogUtil.d("loadUrl...  " + ProcessUtil.getProcessInfo(context));
