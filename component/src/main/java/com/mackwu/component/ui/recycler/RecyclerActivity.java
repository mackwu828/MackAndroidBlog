 ...
 * ===================================================
 */
public class RecyclerActivity extends BaseActivity<RecyclerViewModel, WidgetActivityRecyclerBinding> {
        ...
        binding.recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_DRAGGING || newState == RecyclerView.SCROLL_STATE_SETTLING) {
                    if (!Glide.with(RecyclerActivity.this).isPaused()) {
                        Glide.with(RecyclerActivity.this).pauseRequests();
                    }
                }
                // 静止没有滚动时，开始加载图片
                else if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                    if (Glide.with(RecyclerActivity.this).isPaused()) {
                        Glide.with(RecyclerActivity.this).resumeRequests();
                    }
                }
            }
        });
