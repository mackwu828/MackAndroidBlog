...
//        rootLayout.addView(mHandle, new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT, drawerGravity));
...
//            mHandle.setX(mGravity == GravityCompat.END || mGravity == Gravity.RIGHT ? getScreenWidth() : 0);
//            mHandle.setY(mY);
//        }
//
//    }
...
//    @SuppressLint("NewApi")
//    private void removeOnGlobalLayoutListener(View v, OnGlobalLayoutListener listener) {
