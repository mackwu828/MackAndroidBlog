 ...
 * ===================================================
 */
public class VerticalFragment extends BaseFragment<BaseViewModel, FragmentVerticalBinding> {
    ...
    public void initView(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // 277/198=1.4; 370/264=1.4
         subHorizontalGridViewScaleAnimator = AnimUtil.getScaleAnimator(binding.horizontalGridViewSub, 1.4f, 1.4f,
    ...
    public static VerticalFragment newInstance(LeanbackActivity.LeanbackItem leanbackItem) {
...
//        searchFragment.setArguments(args);
    ...
    private static class SubAdapter extends BaseFocusQuickAdapter<LeanbackActivity.LeanbackItem, BaseViewHolder> {
        ...
        public SubAdapter() {
            super(R.layout.fragment_item_vertical);
        }
...
//                    .override(getContext().getResources().getDimensionPixelOffset(R.dimen.dp_277),
//                            getContext().getResources().getDimensionPixelOffset(R.dimen.dp_370))
//                    .into(imageView);
        }
    }
