...
public final class ScreensaverUtil {
     ...
     */
    private static void setScreensaverActivateOnSleep(Context context) {
     ...
     * 屏保启动场景，睡眠时关闭屏保
     */
    private static void setScreensaverInActivateOnSleep(Context context) {
        Settings.Secure.putInt(context.getContentResolver(), "screensaver_activate_on_sleep", 0);
    }

    private static boolean isScreensaverActivateOnSleep(Context context) {
     ...
     */
    private static void setScreensaverActivateOnDock(Context context) {
     ...
     * 屏保启动场景，连接底座时关闭启动屏保
     */
    private static void setScreensaverInActivateOnDock(Context context) {
        Settings.Secure.putInt(context.getContentResolver(), "screensaver_activate_on_dock", 0);
    }

    private static boolean isScreensaverActivateOnDock(Context context) {
     ...
     * @param screensaverComponent 屏保服务。如 com.mackwu.component/com.mackwu.component.service.ScreenService
     */
    private static void setScreensaverComponent(Context context, String screensaverComponent) {
     ...
     * @param context context
     */
    private static String getScreensaverComponent(Context context) {
     ...
     *
     * @param context    context
     * @param serviceCls 屏保服务。如 com.mackwu.component/com.mackwu.component.service.ScreenService
     */
