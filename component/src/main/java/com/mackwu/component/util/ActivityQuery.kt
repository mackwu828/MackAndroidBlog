...
/**
 * ===================================================
 * Created by MackWu on 2020/1/17 11:16
 ...
 * 获取设备中所有应用包名
 */
fun Context.queryAllPackage(): List<String>{
    val intent = Intent(Intent.ACTION_MAIN)
    val resolveInfos = applicationContext.packageManager.queryIntentActivities(intent, 0)
...
fun Context.queryAllInstalledPackage(): List<String>{
...
fun Context.isPackageInstalled(packageName: String): Boolean{
    return queryAllInstalledPackage().contains(packageName)
}
