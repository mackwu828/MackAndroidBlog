package com.mackwu.component.provider.student
...
class StudentProvider : ContentProvider() {
    ...
    companion object {
        ...
        private const val AUTHORITY = "com.mackwu.component.provider.student.StudentProvider" // 在AndroidManifest.xml中配置的authorities
