...
public class NativeUtil {
     ...
     * 调用native方法
     */
    public static void saveBitmap(Bitmap bitmap, int quality, String filePath, boolean optimize) {
        compressBitmap(bitmap, bitmap.getWidth(), bitmap.getHeight(), quality, filePath.getBytes(), optimize);
    }
