package com.mackwu.video_compress;

import com.arthenica.ffmpegkit.FFmpegKit;
import com.mackwu.video_compress.bean.VideoData;
import com.mackwu.video_compress.retrive.FFmpegKitRetriever;
import com.mackwu.video_compress.retrive.VideoDataRetriever;
...
//            FFmpegSession session = FFmpegKit.execute(command);
        ...
        VideoDataRetriever videoDataRetriever = new FFmpegKitRetriever(inPath);
        VideoData videoData = videoDataRetriever.getVideoData();
        Logger.d("" + videoData);
